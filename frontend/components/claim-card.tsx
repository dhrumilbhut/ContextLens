...
export function ClaimCard({ claim }: ClaimCardProps) {
  ...
  const [chunkExpanded, setChunkExpanded] = useState(!claim.is_faithful);

  const borderClass = VERDICT_BORDER[claim.faithfulness_verdict];
  ...
  return (
    ...
    >
      <div className="p-5">
        ...
        {/* Judge reasoning — always shown, prominent */}
        {claim.judge_reasoning && (
